...
const Home: React.FC = () => {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simplified newsletter submission
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Discover our exclusive collection of premium fashion items. From traditional sarees to trendy western wear, we have everything you need to look your best.
                </p>
              </div>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-blue-100 via-pink-100 to-yellow-100 rounded-2xl p-8 shadow-xl">
                <div className="text-center">
                  <div className="mb-6">
                    <Logo size="xl" showText={false} />
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">JANU COLLECTION</h3>
                  <p className="text-gray-600 mb-4">Premium Fashion for Every Woman</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">info@janucollections.com</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-primary-100 rounded-full mb-4">
                {/* MapPin icon */}
